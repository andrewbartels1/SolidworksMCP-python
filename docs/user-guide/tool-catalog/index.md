# Tool Catalog — All 132 Tools

This reference documents all **132 MCP tools** registered by the SolidWorks MCP server.
...
|----------|-------|-------------|
| [Modeling Tools](modeling.md) | 12 | Create and manipulate SolidWorks parts, assemblies, and drawings — sketches, extrusions, revolves, dimensions, feature renaming, and the document unit system. |
...
| [Drawing Tools](drawing.md) | 13 | Create and edit 2-D technical drawings: add projected, section, and detail views, place annotations, and auto-dimension layouts. |
...
| [File Management Tools](file-management.md) | 18 | Open, save, and manage SolidWorks documents; load parts and assemblies, switch the active document, enumerate what's open, inspect model metadata, and classify model families. |
