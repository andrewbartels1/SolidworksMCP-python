...
### Q2 2027: Automated Reverse-Engineering Loop (8 weeks)

> **Background**: The AI-assisted design workflow described in
> [AI-Assisted Design Workflow](user-guide/ai-assisted-design-workflow.md)
...
#### 5A. Feature Tree Reader (2 weeks)
...
#### 5B. Reconstruction Agent Integration (3 weeks)
...
#### 5C. Validation Pipeline (3 weeks)
