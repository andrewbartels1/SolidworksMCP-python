...
🚀 **122 Tools** | 🤖 **Agent-Ready Workflows** | ⚡ **Automatic COM/VBA Routing** | 🧪 **Schema-Validated Prompt Runs**
...
- 122 tools across modeling, sketching, drawing, analysis, export, automation, templates, macros, and docs discovery
