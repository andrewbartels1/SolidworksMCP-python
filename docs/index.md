...
🚀 **125 Tools** | 🤖 **Agent-Ready Workflows** | ⚡ **Automatic COM/VBA Routing** | 🧪 **Schema-Validated Prompt Runs**
...
- 125 tools across modeling, sketching, drawing, analysis, export, automation, templates, macros, and docs discovery
